...
Following installation, \texttt{autofz} and the individual fuzzers from its pool were deployed on the aforementioned targets. Each 
...
Each algorithm of out final iteration of \texttt{autofz} was evaluated against the four targets, but 
due to time constraints, they were not able to undergo 10 trials.